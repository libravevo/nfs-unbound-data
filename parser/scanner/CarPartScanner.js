            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        part = new CarVisualPart_js_1.CarVisualPart(file, Number(itemData.Id[0].ItemDataId[0].Id[0]), file.includes("shared_") ? "shared" : file.toLowerCase().split("_").at(-1).split(".")[0].replace(/^(set)/, ""));
